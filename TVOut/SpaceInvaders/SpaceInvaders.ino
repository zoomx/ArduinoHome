...
const char PROGMEM s0[] PROGMEM = "HIGH SCORES";
const char PROGMEM s1[] PROGMEM = "PLA";
const char PROGMEM s2[] PROGMEM = "SPACE INVADERS";
const char PROGMEM s3[] PROGMEM = " =  10";
const char PROGMEM s4[] PROGMEM = " =  20";
const char PROGMEM s5[] PROGMEM = " =  30";
const char PROGMEM s6[] PROGMEM = " =  ??";
const char PROGMEM s7[] PROGMEM = "GAME";
const char PROGMEM s8[] PROGMEM = "OVER";


const char PROGMEM *strings[] = {s0, s1, s2, s3, s4, s5, s6, s7, s8};
